...
class UNetModel(nn.Module):
    ...
    def __init__(self,
        ...
        transformer_depth=1,
        context_dim=None,  # cross-attn emb dim
        text_dim=None,    
    ...
    def _forward(self, x, timesteps=None, context=None, mask=None,
        ...
        """
        Forward pass with optional text_embedding fused into context
        """
    ...
    def forward_with_cfg(self, x, timesteps=None, context=None, y=None,
        ...
        cfg_pred = null_out.pred + cfg_scale * (model_out.pred - null_out.pred)

        return Return(pred=cfg_pred)
