...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument("--use_guidance", action='store_true', help="whether to use influence-guided generation")
    parser.add_argument("--guidance_path", type=str, default=None, help="path to the guidance set (e.g., .pkl file)")
    parser.add_argument("--downstream_pth_path", type=str, default=None, help="path to pretrained downstream model for guidance")
    parser.add_argument("--guidance_scale", type=float, default=0.0001, help="scaling factor for influence-guided gradients")
