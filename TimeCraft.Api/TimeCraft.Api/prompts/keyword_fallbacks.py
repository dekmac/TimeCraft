...
def get_keyword_to_tags_mapping() -> dict:
    ...
    return {
        ...
        # Historic Building & Heritage Monitoring
        'historic': ['BUILDING_TEMP_INTERIOR', 'HUMIDITY_ARTIFACT_ZONE', 'FOOTFALL_VISITOR_COUNT', 'SEISMIC_VIBRATION_MONITOR'],
        'building': ['HVAC_ZONE_TEMP', 'INDOOR_HUMIDITY_LEVEL', 'OCCUPANCY_SENSOR_COUNT', 'STRUCTURAL_VIBRATION_SENSOR'],
        'heritage': ['CONSERVATION_TEMP_CTRL', 'RELATIVE_HUMIDITY_RH', 'VISITOR_PRESENCE_DETECT', 'FOUNDATION_MOVEMENT_SENSOR'],
        'monument': ['AMBIENT_TEMP_OUTDOOR', 'MOISTURE_CONTENT_WALL', 'PEOPLE_COUNTER_GATE', 'GROUND_VIBRATION_SEISMIC'],
        'visitor': ['FOOTFALL_COUNTER_MAIN', 'PRESENCE_SENSOR_GALLERY', 'CROWD_DENSITY_MONITOR', 'ENTRY_EXIT_COUNTER'],
        'museum': ['DISPLAY_CASE_HUMIDITY', 'GALLERY_TEMPERATURE', 'VISITOR_FLOW_SENSOR', 'ARTIFACT_ENVIRONMENT_MONITOR'],
        'tourist': ['PEAK_VISITOR_COUNT', 'SEASONAL_OCCUPANCY_RATE', 'TOUR_GROUP_SIZE_SENSOR', 'VISITOR_DWELL_TIME'],
        'spain': ['MEDITERRANEAN_TEMP_SENSOR', 'COASTAL_HUMIDITY_MONITOR', 'TOURIST_SEASON_COUNTER', 'HERITAGE_SITE_MONITOR'],
        ...
        # Building Monitoring Keywords
        'seismic': ['SEISMIC_ACCELEROMETER_X', 'VIBRATION_SENSOR_FOUNDATION', 'STRUCTURAL_MOVEMENT_MONITOR', 'GROUND_MOTION_DETECTOR'],
        'footfall': ['FOOTFALL_COUNTER_ENTRANCE', 'PEOPLE_COUNT_SENSOR', 'VISITOR_TRAFFIC_MONITOR', 'OCCUPANCY_DETECTION_BEAM'],
        'presence': ['PIR_MOTION_SENSOR', 'PRESENCE_DETECTOR_ZONE', 'OCCUPANCY_RADAR_SENSOR', 'VISITOR_DETECTION_CAMERA'],
        'humidity': ['RELATIVE_HUMIDITY_RH01', 'MOISTURE_SENSOR_WALL', 'HUMIDITY_TRANSMITTER_INDOOR', 'ARTIFACT_HUMIDITY_MONITOR'],
...
def get_domain_specific_tags() -> dict:
    ...
    return {
        ...
        'historic_building': [
            "BUILDING_TEMP_INTERIOR", "HUMIDITY_ARTIFACT_ZONE", "FOOTFALL_VISITOR_COUNT",
            "SEISMIC_VIBRATION_MONITOR", "HVAC_ZONE_TEMP", "OCCUPANCY_SENSOR_COUNT",
            "PRESENCE_DETECTOR_GALLERY", "STRUCTURAL_VIBRATION_SENSOR"
        ],
        'oil_gas': [
